...
| `patches/0003-log-agentbox-access-url.patch`                            | Logs the Agentbox browser URL from code-server's resolved server address using code-server's own browser-address normalization.     | Node startup logging   | Startup logging or browser open address handling changes upstream.                |
